<?php
/**
 * Post a saved thread from the library
 */
...
// Forward to post-thread.php logic
...
try {
    ...
    $threads[$threadIndex]['posted'] = true;
    $threads[$threadIndex]['posted_at'] = date('c');
    $threads[$threadIndex]['thread_url'] = "https://x.com/promptband/status/{$firstTweetId}";
